...
const ui = {
  ar: {
    pages: {
      admins: { eyebrow: "المشرفون", title: "الحسابات الإدارية النشطة", listBody: "عرض مضغوط للحسابات الإدارية يوضح الحالة والدور وتوقيت آخر تحديث، مع الانتقال إلى صفحة التفاصيل لإدارة الصلاحيات والتفعيل.", detailBody: "لوحة عمل إدارية مركزة تجمع حالة الحساب وسجل الدعوات ومسار التدقيق في مساحة واحدة متوازنة.", accountOverview: "ملخص الحساب الإداري", accountOverviewBody: "هذه البطاقة تعرض أهم حقائق الحساب قبل تنفيذ أي تغيير حوكمـي أو تشغيلي.", invitations: "سجل الدعوات الإدارية", invitationHistoryBody: "راجع الدعوات السابقة لهذا الحساب، وحالة كل دعوة، وما إذا كانت ما تزال قابلة للاستخدام.", governanceActions: "إجراءات الحوكمة", governanceActionsBody: "استخدم هذه الإجراءات لتحديث الدور أو تعطيل الوصول الإداري مع تسجيل السبب في سجل التدقيق.", inviteTitle: "دعوة مشرف جديد", inviteBody: "لا يتم إنشاء المشرفين إلا عبر الدعوة. يظهر الرمز مرة واحدة هنا ليُرسل عبر قناة داخلية آمنة.", invitationCreatedFor: "تم إنشاء دعوة إلى {email}", invitationMeta: "الدور {role} • تنتهي في {date}", accountMeta: "بدعوة من {actor} • آخر تحديث {date}", notFound: "لم يتم العثور على الحساب الإداري." },
