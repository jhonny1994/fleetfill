...
4.  **Save PRD:** Save the generated document as `prd-[feature-name].md` inside the relevant work-item folder under `docs/workitems/`, or inside a feature-specific subfolder when one already exists.
...
*   **Format:** Markdown (`.md`)
*   **Location:** `docs/workitems/<feature-area>/`
