...
4.  **Save PRD:** Save the generated document as `prd-[feature-name].md` inside the relevant planning folder under `docs/planning/`, or inside a feature-specific subfolder when one already exists.
...
*   **Format:** Markdown (`.md`)
*   **Location:** `docs/planning/<feature-area>/`
