...
const ui = {
  ar: {
    ...
    enums: {
      ...
      payment: { pending: "معلّق", unpaid: "غير مدفوع", submitted: "تم الإرسال", proof_submitted: "تم إرسال الإثبات", under_review: "قيد المراجعة", under_verification: "قيد التحقق", rejected: "مرفوض", secured: "مضمون", refunded: "مسترد", released: "مصروف", released_to_carrier: "تم تحويله إلى الناقل" },
      booking: { pending: "معلّق", pending_payment: "بانتظار الدفع", payment_under_review: "الدفع قيد المراجعة", confirmed: "مؤكد", picked_up: "تم الاستلام", in_transit: "قيد النقل", delivered_pending_review: "تم التسليم بانتظار المراجعة", completed: "مكتمل", canceled: "ملغى", cancelled: "ملغى", disputed: "متنازع عليه" },
      ...
      payout: { pending: "معلّق", released: "مصروف", sent: "تم الإرسال", failed: "فشل", processing: "قيد التنفيذ", cancelled: "ملغى", canceled: "ملغى" },
...
const actionLabels = {
  ar: {
    admin_account_activated: "تمت إعادة تفعيل الحساب الإداري",
    admin_invitation_created: "تم إنشاء دعوة إدارية",
    admin_invitation_accepted: "تم قبول الدعوة الإدارية",
    admin_invitation_revoked: "تم إلغاء الدعوة الإدارية",
    ...
    payment_proof_approved: "تم اعتماد إثبات الدفع",
    ...
    verification_document_approved: "تم اعتماد مستند التحقق",
    verification_document_rejected: "تم رفض مستند التحقق",
    admin_verification_packet_approved: "تم اعتماد ملف التحقق",
    admin_verification_document_reviewed: "تمت مراجعة مستند التحقق",
    dispute_resolved_complete: "تمت تسوية النزاع دون استرداد",
    dispute_resolved_refund: "تمت تسوية النزاع مع استرداد",
    admin_dispute_resolved: "تمت تسوية النزاع",
    payout_released: "تم صرف التحويل",
    admin_payout_released: "تم صرف التحويل",
    support_request_replied: "تم إرسال رد على طلب الدعم",
    support_request_status_updated: "تم تحديث حالة طلب الدعم",
    support_request_assigned: "تم تعيين طلب الدعم",
    admin_support_status_updated: "تم تحديث حالة الدعم",
    admin_support_reply_sent: "تم إرسال رد إداري",
    platform_setting_updated: "تم تحديث إعداد المنصة",
    profile_suspended: "تم تعليق الحساب",
    profile_reactivated: "تمت إعادة تفعيل الحساب",
    email_delivery_resent: "تمت إعادة إرسال البريد الإلكتروني",
    dead_letter_email_resent: "تمت إعادة محاولة رسالة البريد الميتة",
  },
  fr: {
