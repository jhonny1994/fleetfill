...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,environment,supabaseUrl,supabaseAnonKey,firebaseApiKey,firebaseMessagingSenderId,firebaseProjectId,firebaseStorageBucket,firebaseAndroidAppId,firebaseIosAppId,googleAuthEnabled,maintenanceMode,forceUpdateRequired,crashReportingEnabled);

@override
String toString() {
  return 'AppEnvironmentConfig(environment: $environment, supabaseUrl: $supabaseUrl, supabaseAnonKey: $supabaseAnonKey, firebaseApiKey: $firebaseApiKey, firebaseMessagingSenderId: $firebaseMessagingSenderId, firebaseProjectId: $firebaseProjectId, firebaseStorageBucket: $firebaseStorageBucket, firebaseAndroidAppId: $firebaseAndroidAppId, firebaseIosAppId: $firebaseIosAppId, googleAuthEnabled: $googleAuthEnabled, maintenanceMode: $maintenanceMode, forceUpdateRequired: $forceUpdateRequired, crashReportingEnabled: $crashReportingEnabled)';
}
...
as String,googleAuthEnabled: null == googleAuthEnabled ? _self.googleAuthEnabled : googleAuthEnabled // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _AppEnvironmentConfig() when $default != null:
return $default(_that.environment,_that.supabaseUrl,_that.supabaseAnonKey,_that.firebaseApiKey,_that.firebaseMessagingSenderId,_that.firebaseProjectId,_that.firebaseStorageBucket,_that.firebaseAndroidAppId,_that.firebaseIosAppId,_that.googleAuthEnabled,_that.maintenanceMode,_that.forceUpdateRequired,_that.crashReportingEnabled);case _:
  return orElse();
