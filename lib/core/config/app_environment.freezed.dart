...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,supabaseUrl,supabaseAnonKey,firebaseApiKey,firebaseMessagingSenderId,firebaseProjectId,firebaseStorageBucket,firebaseAndroidAppId,firebaseIosAppId,googleWebClientId,googleIosClientId,maintenanceMode,forceUpdateRequired,crashReportingEnabled);
...
switch (_that) {
case _AppEnvironmentConfig() when $default != null:
return $default(_that.supabaseUrl,_that.supabaseAnonKey,_that.firebaseApiKey,_that.firebaseMessagingSenderId,_that.firebaseProjectId,_that.firebaseStorageBucket,_that.firebaseAndroidAppId,_that.firebaseIosAppId,_that.googleWebClientId,_that.googleIosClientId,_that.maintenanceMode,_that.forceUpdateRequired,_that.crashReportingEnabled);case _:
  return orElse();
