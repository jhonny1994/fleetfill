...
mixin _$AppEnvironmentConfig {
 ...
 AppEnvironment get environment; String get supabaseUrl; String get supabaseAnonKey; bool get googleAuthEnabled; bool get maintenanceMode; bool get forceUpdateRequired; bool get crashReportingEnabled;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,environment,supabaseUrl,supabaseAnonKey,googleAuthEnabled,maintenanceMode,forceUpdateRequired,crashReportingEnabled);

@override
String toString() {
  return 'AppEnvironmentConfig(environment: $environment, supabaseUrl: $supabaseUrl, supabaseAnonKey: $supabaseAnonKey, googleAuthEnabled: $googleAuthEnabled, maintenanceMode: $maintenanceMode, forceUpdateRequired: $forceUpdateRequired, crashReportingEnabled: $crashReportingEnabled)';
}
...
@useResult
$Res call({
 AppEnvironment environment, String supabaseUrl, String supabaseAnonKey, bool googleAuthEnabled, bool maintenanceMode, bool forceUpdateRequired, bool crashReportingEnabled
});
...
/// Create a copy of AppEnvironmentConfig
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? environment = null,Object? supabaseUrl = null,Object? supabaseAnonKey = null,Object? googleAuthEnabled = null,Object? maintenanceMode = null,Object? forceUpdateRequired = null,Object? crashReportingEnabled = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( AppEnvironment environment,  String supabaseUrl,  String supabaseAnonKey,  bool googleAuthEnabled,  bool maintenanceMode,  bool forceUpdateRequired,  bool crashReportingEnabled)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppEnvironmentConfig() when $default != null:
return $default(_that.environment,_that.supabaseUrl,_that.supabaseAnonKey,_that.googleAuthEnabled,_that.maintenanceMode,_that.forceUpdateRequired,_that.crashReportingEnabled);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( AppEnvironment environment,  String supabaseUrl,  String supabaseAnonKey,  bool googleAuthEnabled,  bool maintenanceMode,  bool forceUpdateRequired,  bool crashReportingEnabled)  $default,) {final _that = this;
switch (_that) {
case _AppEnvironmentConfig():
return $default(_that.environment,_that.supabaseUrl,_that.supabaseAnonKey,_that.googleAuthEnabled,_that.maintenanceMode,_that.forceUpdateRequired,_that.crashReportingEnabled);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( AppEnvironment environment,  String supabaseUrl,  String supabaseAnonKey,  bool googleAuthEnabled,  bool maintenanceMode,  bool forceUpdateRequired,  bool crashReportingEnabled)?  $default,) {final _that = this;
switch (_that) {
case _AppEnvironmentConfig() when $default != null:
return $default(_that.environment,_that.supabaseUrl,_that.supabaseAnonKey,_that.googleAuthEnabled,_that.maintenanceMode,_that.forceUpdateRequired,_that.crashReportingEnabled);case _:
  return null;
...
class _AppEnvironmentConfig extends AppEnvironmentConfig {
  const _AppEnvironmentConfig({required this.environment, this.supabaseUrl = '', this.supabaseAnonKey = '', this.googleAuthEnabled = false, this.maintenanceMode = false, this.forceUpdateRequired = false, this.crashReportingEnabled = false}): super._();
...
/// Create a copy of AppEnvironmentConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? environment = null,Object? supabaseUrl = null,Object? supabaseAnonKey = null,Object? googleAuthEnabled = null,Object? maintenanceMode = null,Object? forceUpdateRequired = null,Object? crashReportingEnabled = null,}) {
